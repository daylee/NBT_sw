...
void setup() {
  ...
  delay(1000);
  pinMode(HUZZAH_RESET,OUTPUT);
  digitalWrite(HUZZAH_RESET,LOW);
  delay(50);
  digitalWrite(HUZZAH_RESET,HIGH);
  ...
  pinMode(LSX,INPUT_PULLDOWN); // Pull down to 3.3V
...
void CoMA_HOME(){
  ...
  Serial.println("Attempting to home stepper motors");
...
void CoMA_Position_Update(){
  ...
  COMA1 = constrain(HW_Serial_Packet.CoMA1_X,0,22*25.4);
  COMA2 = constrain(HW_Serial_Packet.CoMA2_X,0,22*25.4);
  COMA3 = constrain(HW_Serial_Packet.CoMA3_X,0,22*25.4);
  COMA4 = constrain(HW_Serial_Packet.CoMA4_X,0,22*25.4);
...
void commandPrintOut(){
  ...
  Serial.print(" RW1: ");
  Serial.print(Commanded_RPM_1);
  Serial.print(" RW2: ");
  Serial.print(Commanded_RPM_2);
  Serial.print(" RW3: ");
